...
//Rota do tipo get callback(requisição resposta)
router.get('/', (req, res) => {
    //resposta.enviar
...
router.get('/categorias/edit/:id', (req, res) => {
    Categorias.findOne({ _id: req.params.id }).lean().then((categoria) => {
        res.render('admin/editcategorias.handlebars', { categoria })
    }).catch((error) => {
...
router.post('/postagem/edit',(req,res)=>{
    Postagem.findOne({_id: req.body.id}).then((postagem)=>{ 
        ...
        postagem.conteudo = req.body.categoria

        postagem.save().then(()=>{
            req.flash('success_msg','Postagem editada com sucesso')
            res.redirect('/admin/postagens')
        }).catch((error)=>{
            req.flass('error_msg','Erro interno')
            res.redirect('/admin/postagens')
        })
    }).catch((error)=>{
...
router.get('/postagens/deletar/:id',(req,res)=>{
    Postagem.remove({_id: req.params.id}).then(()=>{
        ...
        res.flash('erro_msg','Houve um erro interno')
        res.redirect('/admin/postagens')
    })
})


module.exports = router //sempre por ultimo segundo o instrutor